...
def main():
    ...
    with st.sidebar:
        ...
        Identificando Vieses em IA. Plataforma de Inteligência Artificial Aplicada à Educação Básica. Versão Atualizada, 2024. Disponível em: https://aieduca.streamlit.app/. Acesso em: [DATA]. DOI: 10.5281/zenodo.15692437""")
